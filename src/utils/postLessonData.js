...
var base = new Airtable({ apiKey: { Airtable_api_key } }).base("appnneO9UdlcBo0C3");

Airtable.configure({
  endpointUrl: 'https://airtable.com/tbl5vlOrQjCPQ5Wrl/viwbNivzUaYOsHqfU?blocks=hide',
  apiKey: Airtable_api_key
})

const postLessonData = ({ photo, dishName, lessonLength, lessonDates, lessonHours, location, distanceToTravel, skillLevel, ingredients, description, dietaryOptions }) => {
